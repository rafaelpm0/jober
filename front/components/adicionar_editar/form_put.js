import { handleChangeObjectEvent, handleChangeImage, handlBoelano } from "../handles/handles";
import styles from '../../styles/forms/forms.module.css'

export default function FormPut({ handleForm, include, setInclude, delet, setDelet}) {
  return (
